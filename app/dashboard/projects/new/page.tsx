            ...
            <form action={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <section className="bg-[#1E293B] p-6 rounded-xl border border-gray-700 space-y-4">
                            <h2 className="font-semibold text-white flex items-center gap-2">Project Type & Scope</h2>
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (e.target.value === 'CLUSTER') {
                                            ...
                                            // @ts-ignore
                                            document.querySelector('input[name="total_distributions"]').value = 1;
                                        }
                                    }}
                                >
                            ...
                            <div id="dist-input" className="hidden transition-all">
                                <label className="block text-xs font-medium text-gray-400 mb-1.5">Jumlah Distribusi (Min 1)</label>
                                <input
                                    type="number"
                                    name="total_distributions"
                                    min="1"
                                    defaultValue="1"
                                    className="w-full px-4 py-2 bg-[#0F172A] border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all placeholder:text-gray-600"
                                />
                                <p className="text-[10px] text-gray-500 mt-1">Untuk CLUSTER, tentukan berapa jumlah distribusi yang akan dikerjakan.</p>
                            </div>
                        </section>
